...
int main() {
    ...
    cout << tester2;
    cout << avlTree;
    cout << tester.contains("d");
    cout << tester.contains("e");
    vector<string> fill = avlTree.findRange("a", "c");
    vector<string> fill2 = avlTree.keys();
    cout << endl << "buffer text" << endl;
    size_t size = avlTree.size();
    cout << size;
    avlTree["d"] = 43;
    cout << avlTree << endl;
    cout << avlTree.getHeight();
    avlTree.remove("d");
    avlTree.remove("e");
    avlTree.remove("f");
    avlTree.remove("g");
